...
| PART-3 | Dials and encoders | Distinguish a replacement knob from an encoder; placement, shaft/mount, PCB and firmware requirements affect compatibility; selected parts survive save/share/undo | In progress: selection, persistence and compatibility boundaries implemented; verified host slots and embedded geometry remain |
