...
| COMMUNITY-3 | Creator build pages | Creator attribution, immutable published revision, source-backed parts and honest sound/geometry scope; recipient can experience it without changing existing local work | In progress: portable configuration previews implemented; verified creator attribution and immutable server publication remain pending |
