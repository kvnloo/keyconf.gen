...
| PART-4 | Screens and extra controls | Distinguish integrated modules from external displays, buttons and macropads; mounting, connectors, power and firmware support are sourced or unknown; no arbitrary snap-on fit | In progress: module planning and external macropad preview implemented; embedded host integration remains |
